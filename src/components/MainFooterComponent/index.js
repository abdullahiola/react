...
import cwayHome from "../../assets/images/home.svg"
    ...
    <Footer>
      ...
      <Footer.Wrapper>
        <Footer.Row>
          <Footer.Column>
            <Footer.Title>
              <Footer.CwayLogo style={{ height: "60px" }} src={cwayHome} alt='Logo' />
            </Footer.Title>
            <Footer.Link href="#"><Footer.CwayLogo style={{ height: "15px" }} src={addRess} alt='address' /> Story</Footer.Link>
            <Footer.Link href="#"><Footer.CwayLogo style={{ height: "15px" }} src={callus} alt='callus' /> Clients</Footer.Link>
            <Footer.Link href="#"><Footer.CwayLogo style={{ height: "15px" }} src={email} alt='email' /> Testimonials</Footer.Link>
          </Footer.Column>
          <Footer.Column>
          ...
          <Footer.Column>
            ...
            <Footer.Link href="#">
              <Footer.CwayLogo style={storescard} src={applestore} alt='applestore' />

            </Footer.Link>
            <Footer.Link href="#">

              <Footer.CwayLogo style={storescard2} src={googleplay} alt='googleplay' />
            </Footer.Link>
            <Footer.Link href="#" style={paymentpara2}>Secured Payment Gateways</Footer.Link>
            <Footer.CwayLogo style={paymentcards} src={paymentmethod} alt='payment' />
          </Footer.Column>
          <Footer.Column>
            <Footer.Horizontal></Footer.Horizontal>
